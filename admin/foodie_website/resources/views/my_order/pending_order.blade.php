		...
		completedorsersref.get().then( async function(completedorderSnapshots){
			...
			var billingName='';
			 ...
			 var scheduleTime = '';
				...
				if(orderDetails.status=="Order Accepted"){
					    ...
					    $('.prepare_time').append('<label class="col-12 control-label pl-0"><strong>{{trans("lang.prepare_time")}}:</strong><span id=""> ' + time + '</span></label>')
